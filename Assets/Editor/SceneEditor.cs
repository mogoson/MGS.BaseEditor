...
namespace MGS.Editors
{
    public class SceneEditor : Editor
    {
        ...
        protected void DrawSphereArrow(Vector3 start, Vector3 end, float size, string label = "")
        {
        ...
        protected void DrawSphereArrow(Vector3 start, Vector3 direction, float length, float size, string label = "")
        {
            DrawSphereArrow(start, start + direction.normalized * length, size, label);
        }

        protected void DrawAdaptiveSphereArrow(Vector3 start, Vector3 direction, float length, float size, string label = "")
        {
            DrawSphereArrow(start, direction, length * GetHandleSize(start), size, label);
        }
